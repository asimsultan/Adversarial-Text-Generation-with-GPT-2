...
from utils import get_device, preprocess_text, AdversarialTextDataset
...
def main(data_path):
    ...
    # DataLoader
    train_dataset = AdversarialTextDataset(train_encodings)
    val_dataset = AdversarialTextDataset(val_encodings)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, required=True, help='Path to the CSV file containing adversarial text data')
